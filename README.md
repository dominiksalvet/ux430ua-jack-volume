...
All files of this project are implicitly licensed under an [Open Source Initiative](https://opensource.org/) approved license, the MIT License. See the [*LICENSE.txt*](LICENSE.txt) file for details. However, individual files may contain the [SPDX](https://spdx.org/) license identifier as a shortcut for the full text of some license, and in this case they are always licensed under the license defined by that license identifier even if it differs from the project license.
